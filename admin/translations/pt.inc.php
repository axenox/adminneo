...
return [
	...
	'Collect runtime statistics' => 'Recolher estatísticas de execução', // by GitHub Copilot
	'Runs only read-only SELECT statements. Statistics collection adds instrumentation overhead.' => 'Executa apenas instruções SELECT de leitura. A recolha de estatísticas acrescenta sobrecarga de instrumentação.', // by GitHub Copilot
	'Runtime statistics' => 'Estatísticas de execução', // by GitHub Copilot
	'Statistics were collected by executing an instrumented copy of this query and add overhead.' => 'As estatísticas foram recolhidas executando uma cópia instrumentada desta consulta e acrescentam sobrecarga.', // by GitHub Copilot
